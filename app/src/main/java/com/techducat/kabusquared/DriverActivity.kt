...
import com.techducat.kabusquared.db.TripEntity
import com.techducat.kabusquared.db.TripRepository
import javax.inject.Inject
import com.techducat.kabusquared.model.*
import com.techducat.kabusquared.service.I2PKabuService
import com.techducat.kabusquared.ui.RequestAdapter
import com.techducat.kabusquared.wallet.RideWalletManager
import com.techducat.kabusquared.wallet.WalletSuite
...
class DriverActivity :
    ...
    override fun onI2PStateChanged(state: String) {
        runOnUiThread {
            when (state) {
                com.techducat.kabusquared.service.I2PKabuService.I2P_STATE_BOOTSTRAPPING,
                com.techducat.kabusquared.service.I2PKabuService.I2P_STATE_BUILDING_TUNNELS -> {
                    tvDriverStatus.text = getString(R.string.i2p_status_bootstrapping)
                }
                com.techducat.kabusquared.service.I2PKabuService.I2P_STATE_READY -> {
                ...
                com.techducat.kabusquared.service.I2PKabuService.I2P_STATE_ERROR -> {
    ...
    private fun getI2PDestination(): String {
        return try {
            val cls         = Class.forName("com.techducat.kabusquared.network.I2PTransport")
