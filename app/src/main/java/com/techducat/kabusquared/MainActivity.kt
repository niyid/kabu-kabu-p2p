...
class MainActivity :
    ...
    private fun estimateFare(): Long =
        com.techducat.kabusquared.network.FareEstimator.estimate(
            pickupGeohash  = lastKnownGeohash,
            dropoffGeohash = "",              // dropoff unknown at request time
            serviceType    = if (currentRole == "courier_sender")
                                 com.techducat.kabusquared.model.ServiceType.COURIER
                             else
                                 com.techducat.kabusquared.model.ServiceType.TAXI
        )
