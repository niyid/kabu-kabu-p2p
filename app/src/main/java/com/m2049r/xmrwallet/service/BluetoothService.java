...
public class BluetoothService {
    ...
    public synchronized void startConnected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        try {
            ...
            Timber.e(e, "Permission denied for device.getName()");
        }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = bluetoothAdapter.listenUsingRfcommWithServiceRecord(SDP_NAME, SDP_UUID);
                state = BluetoothService.State.LISTEN;
            } catch (IOException ex) {
                Timber.d(ex, "listen() failed");
                throw new IllegalStateException();
            } catch (SecurityException ex) {
                Timber.e(ex, "Permission denied for listenUsingRfcommWithServiceRecord()");
                throw new IllegalStateException("Bluetooth permission denied");
            }
            serverSocket = tmp;
        }
        ...
        public void run() {
            ...
            while (state != BluetoothService.State.CONNECTED) {
                try {
                    ...
                    Timber.e(ex, "Permission denied for serverSocket.accept()");
                    break;
                }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Timber.e(ex, "Permission denied for createRfcommSocketToServiceRecord()");
                throw new IllegalStateException("Bluetooth permission denied");
            }
            socket = tmp;
        }
        ...
        public void run() {
            ...
            try {
                ...
                Timber.e(ex, "Permission denied for cancelDiscovery()");
                // Continue anyway, just won't cancel discovery
            }
            ...
            try {
                ...
                Timber.e(ex, "Permission denied for socket.connect()");
                try {
                    socket.close();
                } catch (IOException exClose) {
                    Timber.d(exClose, "unable to close() socket during connection failure");
